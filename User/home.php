        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="background-color: lightblue">
                    <div class="card-header" align="center" style="background-color: #096ca5;">Riwayat Pinjam</div>
                        ...
                        <table class="table table-bordered" id="myTable" style="background-color: blue;">
                            <thead>
                                <tr class="text-info" style="background-color:white ;">
                                    <th scope="col" style="background-color: black;">ID Peminjam</th>
                                    <th scope="col" style="background-color: black;">Tanggal Pinjam</th>
                                    <th scope="col" style="background-color: black;">Id Buku</th>
                                    <th scope="col" style="background-color: black;">Id User</th>
                            ...
                            <tbody>
                                <?php
                                    include('config.php');
                                    $no = 1;
                                    $query = mysqli_query($conn, "SELECT * FROM riwayat_pinjam");
