...
<html lang="en">
  <head>
			...
			<div class="row justify-content-center" >
				<div class="col-md-12 col-lg-10" >
					<div class="wrap d-md-flex" style="border-radius: 10%; box-shadow: 2px 2px black;">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
			      			<h2 class="mb-4" style="text-align: center; color: white">Login Admin</h2>
			      		</div>
			      	</div>
		          ...
		          <!-- <p class="text-center">Anda Belum Mendaftar menjadi member? <a data-toggle="tab" href="#signup">Member</a></p> -->
		        </div>
		      </div>
				</div>
			</div>
	...
	<?php 
  		...
  		?>
  		<input type="hidden" name="nama1"><?php echo $read['nama'] ?>
