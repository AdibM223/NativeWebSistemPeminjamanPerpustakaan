...
<body>
  <div class="sidebar" style="background-color: #071c47">
    ...
    <ul class="nav-list">
     ...
     <li class="profile">
        ...
        ?>
             <div class="name"><?php echo $read['nama']; ?></div>
  ...
  <section class="home-section" style="background-color: #096ca5">
      <div class="text" style="color: white;">PENGEMBALIAN</div>
          ...
          <table class="table table-bordered" id="myTable">
            ...
            <tbody>
              <?php  
                include('config.php');
                $no = 1;
                $query = mysqli_query($conn,"SELECT * from riwayat_pinjam join buku on riwayat_pinjam.id_buku = buku.id_buku");
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href="kembalikan.php?id=<?php echo $row['id_buku'] ?>" class="btn btn-sm btn-danger">KEMBALIKAN</a>
                </td>
              </tr>
            <?php } ?>
            </tbody>
