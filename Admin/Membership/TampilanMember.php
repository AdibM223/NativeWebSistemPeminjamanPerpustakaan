...
<body>
  <div class="sidebar" style="background-color: #071c47">
    ...
    <ul class="nav-list">
     ...
     <li>
       <a href="TampilanMember.php" style="background-color: #096ca5">
         <i class='bx bx-pie-chart-alt-2' style="background-color: #096ca5"></i>
  ...
  <section class="home-section" style="background-color: #096ca5">
      <div class="text" style="color: white;">DAFTAR MEMBER</div>
                           ...
                           <tbody>
                               ...
                               <tr>
                                   ...
                                   <td class="text-center">
                                       <a href="edit_membership.php?id=<?php echo $row['id_user']?>" class="btn btn-sm btn-primary btn-lg">Edit</a>
                                       <a href="hapus_membership.php?id=<?php echo $row['id_user']?>" class="btn btn-sm btn-danger btn-sm">Hapus</a>
                                   </td>
                               </tr>
